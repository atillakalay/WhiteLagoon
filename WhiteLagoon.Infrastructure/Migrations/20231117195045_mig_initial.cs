    ...
    public partial class mig_initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.", "https://placehold.co/600x400", "Kraliyet Villası", 4, 200.0, 550, null },
                    { 2, null, "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.", "https://placehold.co/600x401", "Premium Havuzlu Villa", 4, 300.0, 550, null },
                    { 3, null, "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.", "https://placehold.co/600x402", "Lüks Havuzlu Villa", 4, 400.0, 750, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, null, "1 kral yatağı ve 1 koltuk", 1 },
                    { 5, null, "Özel Dalma Havuzu", 2 },
                    { 6, null, "Mikrodalga ve Mini Buzdolabı", 2 },
                    { 7, null, "Özel Balkon", 2 },
                    { 8, null, "kral yatağı veya 2 adet çift kişilik yatak", 2 },
                    { 9, null, "Özel Havuz", 3 },
                    { 10, null, "Jakuzi", 3 },
